...
def get_grouped_hist(group_x_data, group_y_data, group_x_name, group_y_name, var_name, figsize=(7, 5), bins=10):
    ...
    ax.hist(group_x_data, bins=bins, alpha=0.6, label=f'Image {var_name} {group_x_name}', color='blue',
            edgecolor='white', zorder=2)
    ax.hist(group_y_data, bins=bins, alpha=0.7, label=f'Image {var_name} {group_y_name}', color='forestgreen',
            edgecolor='white', zorder=2)
